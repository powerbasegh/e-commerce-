    ...
    <div className="min-h-screen bg-pb-gray-bg">
      ...
      <aside className="fixed inset-y-0 left-0 z-30 hidden w-64 flex-col bg-pb-navy lg:flex">
        <div className="flex h-16 items-center border-b border-white/10 px-5">
          <BrandLogo compact light to="/admin" />
        </div>
        <div className="px-5 py-4">
          <p className="text-[11px] font-semibold uppercase tracking-wide text-white/40">Admin Console</p>
          <p className="mt-0.5 truncate text-sm font-semibold text-white">{user?.fullName || 'Admin'}</p>
        </div>
        <AdminNav />
