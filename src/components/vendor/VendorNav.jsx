...
import { VENDOR_NAV_ITEMS } from './vendorNavItems.js'

export default function VendorNav({ onNavigate }) {
  return (
    <nav aria-label="Vendor" className="flex flex-1 flex-col gap-1 px-3">
